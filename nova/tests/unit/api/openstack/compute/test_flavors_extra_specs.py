...
class FlavorsExtraSpecsTestV21(test.TestCase):
    ...
    def test_index_no_data(self):
        self.stubs.Set(flavor_obj, '_flavor_extra_specs_get_db',
    ...
    def test_delete(self):
        flavor = dict(test_flavor.fake_flavor,
                      extra_specs={'key5': 'value5'})
        self.stubs.Set(flavor_obj, '_flavor_extra_specs_delete_db',
    ...
    def test_create(self):
        self.stubs.Set(flavor_obj,
                       '_flavor_extra_specs_update_or_create_db',
