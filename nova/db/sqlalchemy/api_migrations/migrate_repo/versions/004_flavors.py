...
def upgrade(migrate_engine):
    ...
    # so trying to add a second index on the flavor_id and key columns
    # will fail with error SQL0605W, so omit the index in the case of DB2.
    if migrate_engine.name != 'ibm_db_sa':
        Index('flavor_id_key_idx', flavor_extra_specs.c.flavor_id,
